...
class TestBase(unittest.TestCase):
    ...
    def test_save_to_file(self):
        ...
        with open("Rectangle.json", "r") as f:
            self.assertEqual(f.read(), '[{"x": 2, "size": 10, "id": 3, "y": 8}, {"x": 0, "size": 2, "id": 4, "y": 0}]')
            self.assertEqual(f.read(), '[{"id": 4, "width": 10, "height": 7, "x": 2, "y": 8}, {"x": 0, "size": 2, "id": 4, "y": 0 }]')
        s1 = Square(10, 2, 8)
        s2 = Square(2, 4)
    ...
    def test_load_from_file(self):
        ...
        self.assertEqual(str(list_rectangles_output[0]), "[Rectangle] (4) 2/8 - 10/7")
        self.assertEqual(str(list_rectangles_output[1]), "[Rectangle] (2) 0/0 - 2")
        s1 = Square(10, 2, 8)
        s2 = Square(2, 4)
        Square.save_to_file([s1, s2])
        list_squares_output = Square.load_from_file()
        self.assertEqual(str(list_squares_output[0]), "[Square] (3) 2/8 - 10" )
        self.assertEqual(str(list_squares_output[1]), "[Square] (4) 0/0 - 2")
    ...
    def test_save_to_file_csv(self):
        ...
        with open("Rectangle.csv", "r") as f:
            self.assertEqual(f.read(), '[{"x": 2, "width": 10, "id": 1, "height": 7, "y": 8}, {"x": 0, "size": 2, "id": 4, "y": 0 }]')
        s1 = Square(10, 2, 8)
        s2 = Square(2, 4)
